  ...
  <body>
	...
	<hr>
      <div class="row">
		...
		<h1>Contact</h1>
			<form class="well">
				<input type="text" class="span4" placeholder="Name"><br>
				<input type="email" class="span4" placeholder="Email"><br>
				<input type="text" class="span4" placeholder="Subject"><br>
				<textarea class="span7" placeholder="Message"></textarea>
				<span class="help-block">Did you fill in all of the fields?</span>
				<label class="checkbox">
				<input type="checkbox"> This is worth contacting you about
				</label>
